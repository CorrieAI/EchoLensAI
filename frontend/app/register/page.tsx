  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.needsApproval) {
        ...
        // User is active, redirect to home
        router.push('/')
      }
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-950">
      ...
      <div className="absolute inset-0 overflow-visible pointer-events-none">
        <svg className="w-[120%] h-[120%] absolute -left-[10%] -top-[10%]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
          <defs>
            <linearGradient id="lineGradient-register" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <radialGradient id="nodeGlow-register">
          ...
          {[...Array(56)].map((_, i) => {
            ...
            const size = i === 28 ? 1 : (0.3 + ((i * 3) % 3) * 0.1)
            ...
            return (
              <g key={`node-${i}`}>
                <circle
                  ...
                  filter={isPrimary ? "url(#glow-register)" : undefined}
                >
                  <animate
          ...
          {[...Array(56)].map((_, i) => {
            ...
            return connections.map(conn => (
              <line
                ...
                x2={`${conn.x2}%`}
                y2={`${conn.y2}%`}
                stroke="url(#lineGradient-register)"
                strokeWidth="0.15"
                opacity="0.15"
              >
                <animate
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 border border-gray-200 dark:border-gray-700">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {approvalMessage || 'Your account has been created successfully, but requires admin approval before you can log in. You will receive a notification once your account has been activated.'}
              </p>
              ...
              <p className="mt-4 text-xs text-gray-500 dark:text-gray-400">
                You can close this window and return later. Contact an administrator if you need immediate access.
              </p>
            </div>
          </div>
        </div>
